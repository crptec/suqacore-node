...
var suqacorenode = require('..');
var utils = require('../utils');

function main(servicesPath, additionalServices) {
  /* jshint maxstatements: 100 */

  var version = suqacorenode.version;
  var create = suqacorenode.scaffold.create;
  var add = suqacorenode.scaffold.add;
  var start = suqacorenode.scaffold.start;
  var remove = suqacorenode.scaffold.remove;
  var callMethod = suqacorenode.scaffold.callMethod;
  var findConfig = suqacorenode.scaffold.findConfig;
  var defaultConfig = suqacorenode.scaffold.defaultConfig;
  ...
  program
    ...
    .option('-d, --datadir <dir>', 'Specify the SUQA database directory')
  ...
  program
    ...
    .option('-c, --config <dir>', 'Specify the directory with SUQA Node configuration')
    .option('-d, --daemon', 'Make suqacore-node a daemon (running in the background)')
    .action(function(cmd){
      if (cmd.config) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `suqacore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ suqacore-node add wallet-service');
      console.log('    $ suqacore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ suqacore-node remove wallet-service');
      console.log('    $ suqacore-node remove insight-api');
      console.log();
    });
