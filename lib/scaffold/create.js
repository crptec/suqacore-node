...
var BASE_PACKAGE = {
  description: 'A full SUQA node build with suqacore',
  repository: 'https://github.com/crptec/suqacore-node',
  license: 'MIT',
  readme: 'README.md',
  dependencies: {
    'suqacore-lib': '^' + suqacore.version,
    'suqacore-node': version
  }
};

/**
 * Will create a directory and SUQA.conf file for SUQA.
...
/**
 * Will create a base suqacore Node configuration directory and files.
 * @param {Object} options
 * @param {String} options.network - "testnet" or "livenet"
 * @param {String} options.datadir - The SUQA database directory
...
function createConfigDirectory(options, configDir, isGlobal, done) {
  mkdirp(configDir, function(err) {
    ...
    try {
      fs.writeFileSync(configDir + '/suqacore-node.json', configJSON);
      if (!isGlobal) {
...
/**
 * Will setup a directory with a suqacore Node directory, configuration file,
 * SUQA configuration, and will install all necessary dependencies.
 *
 * @param {Object} options
 * @param {String} options.cwd - The current working directory
 * @param {String} options.dirname - The name of the suqacore node configuration directory
 * @param {String} options.datadir - The path to the SUQA datadir
...
function create(options, done) {
  ...
  async.series([
    function(next) {
      // Setup the the suqacore-node directory and configuration
